...
/**
 * This is what Daniel Lemirecalled Bloofi2. Basically, instead of using a tree
...
public final class FlatBloofi implements AutoCloseable {
    ...
    // * for the position. So filterSet[0] is a bit map of 64 index entries if the
    // bit
    ...
    //
    // /*
    // * remove is the map of all entries that we know do not match so remove all
    // the
