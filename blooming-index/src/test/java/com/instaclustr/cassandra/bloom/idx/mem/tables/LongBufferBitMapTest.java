...
public class LongBufferBitMapTest {
    ...
    public void orTest() {
        ...
        LongBufferBitMap expected = new LongBufferBitMap(
                LongBuffer.wrap(new long[] { 0x7777777777777777L, 0x7777777777777777L }));
        bitMap.or(other);
    ...
    public void xorTest() {
        ...
        LongBuffer other = LongBuffer.wrap(new long[] { 0x7171717171717171L, 0x1717171717171717L });
        LongBufferBitMap expected = new LongBufferBitMap(
                LongBuffer.wrap(new long[] { 0x7676767676767676L, 0x6767676767676767L }));
        bitMap.xor(other);
