...
//        int idx;
//        Callable<Boolean> isSet=new Callable<Boolean>(){@Override public Boolean call()throws IOException{return idxTable.isSet(idx);}};
...
//
//        Callable<Object> clear=new Callable<Object>(){@Override public Object call()throws IOException{idxTable.clear(idx);return"";}};
//
//        W(int id, IdxTable idxTable, ExecutorService executor, int loops, IntConsumer consumer) {
//            super( id, idxTable, executor );
//            this.loops = loops;
